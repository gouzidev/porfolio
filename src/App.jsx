    ...
    return (
      ...
      >
        <h3 className='flex justify-center font-sans md:text-5xl'>Contact</h3>
          <input className='h-10 w-1/2 focus:outline-none border-zinc-700 border-1 p-5 rounded-md' name="name"  placeholder='name'/>
          <input className='h-10 w-1/2 focus:outline-none border-zinc-700 border-1 p-5 rounded-md' name="email"  placeholder='email'/>
          <input className='h-30 w-1/2 focus:outline-none border-zinc-700 border-1 p-5 rounded-md' name="message"  placeholder='message'/>
          <button  type='submit' className='w-1/2 bg-zinc-700/50 py-4 transition-all cursor-pointer hover:bg-zinc-700/30 rounded-lg'>send</button>
      </form>
      </Container>
    )
}
